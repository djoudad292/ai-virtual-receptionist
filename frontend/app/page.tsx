    ...
    <div className="min-h-screen bg-bg text-fg">
      ...
      <header className="fixed top-0 z-50 w-full border-b border-slate-800 bg-bg backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6">
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg font-semibold text-fg">AI Receptionist</span>
          </div>
          <div className="flex items-center gap-3">
            ...
            <Link href="/register" className="rounded-lg bg-primary px-4 py-2 text-sm font-medium text-white hover:bg-primary-strong transition-colors">Get Started</Link>
          </div>
        </div>
      </header>
          ...
          <div className="grid gap-8 lg:grid-cols-2 lg:gap-12 items-center">
            ...
            <div>
              ...
              <h1 className="mb-4 text-3xl font-bold leading-tight sm:text-5xl">
                ...
                <span className="block text-primary">Answers, Books, Captures &amp; Routes</span>
              </h1>
      ...
      <section id="features" className="px-4 py-16 sm:py-20 border-t border-slate-800/40">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="mb-12 text-center text-fg-muted max-w-xl mx-auto">Answer questions, qualify visitors, book meetings and route them to the right team.</p>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {features.map((f) => (
              <div key={f.title} className="rounded-xl border border-slate-800 bg-surface p-6 transition-colors hover:border-border">
                ...
                <p className="text-sm leading-relaxed text-fg-muted">{f.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="how-it-works" className="px-4 py-16 sm:py-20 border-t border-slate-800/40">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {steps.map((s) => (
              <div key={s.num} className="rounded-xl border border-slate-800 bg-surface p-6">
                <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-xl bg-primary/10 text-primary font-bold">{s.num}</div>
      ...
      <section className="px-4 py-16 sm:py-20 border-t border-slate-800/40">
        <div className="mx-auto max-w-2xl rounded-2xl border border-slate-800 bg-surface p-8 text-center sm:p-12">
          ...
          <p className="mb-6 text-fg-muted">Create a free account, add your knowledge base, and test the live widget in minutes. No credit card needed.</p>
